...
export default ()=>{
    return(
        <div>
            ...
            <img src="logo.png" className="navbar-brand" width="150" height="60"></img>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li className="nav-item dropdown">
                    ...
                    <a className="dropdown-item" href="#">Profil Kampus</a>
                    <a className="dropdown-item" href="#">Organisasi</a>
                    <div className="dropdown-divider"></div>
                    <a className="dropdown-item" href="#">Fasilitas</a>
                    </div>
                </li>
                </ul>
